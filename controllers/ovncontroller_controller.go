...
// +kubebuilder:rbac:groups="security.openshift.io",resourceNames=ovn-controller,resources=securitycontextconstraints,verbs=use
	...
	rbacRules := []rbacv1.PolicyRule{
		{
			...
			ResourceNames: []string{"ovn-controller"},
