...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/test v0.0.0-20230301145136-e77d8d19c2ff
...
require (
	...
	github.com/openstack-k8s-operators/keystone-operator/api v0.0.0-20230228134841-fb328205d879 // indirect
